...
let calculate_page_ranks [n] (links:[][2]i32) (ranks: [n]f32) (sizes:[n]i32) : []f32 =
  let get_rank (idx:i32) : f32 = if sizes[idx] == 0 then 0f32 else ranks[idx] / (f32.i32 sizes[idx])
  let contribution = map (\t -> unsafe (get_rank t[0])) links
...
let calculate_ranks [n] (links:[][2]i32) (ranks_in: [n]f32) (sizes:[n]i32) (iterations:i32) : []f32 =
...
let main (links:[][2]i32, sizes:[]i32): []f32 =
